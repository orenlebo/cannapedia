...
const navItems: NavItem[] = [
  ...
  { href: "/saved", label: "שמורים", icon: <SavedIcon className="h-6 w-6" /> },
];
...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 border-t border-nav-border bg-nav-bg/95 backdrop-blur-sm md:hidden">
